...
/// ✅ Rechercher des bus et naviguer vers la page de résultats
void _searchBuses() async {
  ...
  try {
    ...
    // On vérifie que le widget est toujours monté avant d'utiliser context
    if (!mounted) return;
          ...
          return SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return SizedBox(
                  height: 270,  // ou même double.infinity dans certains cas
                  child: _buildRecentSearchCard(snapshot.data![index]),
                );
              },
            ),
          );
